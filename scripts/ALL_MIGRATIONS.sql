-- ============================================================
-- LAUNCHPAD: Run this entire file in Supabase SQL Editor
-- Project: https://supabase.com/dashboard/project/zqtnmznyyzjstmtqcscv/sql/new
-- ============================================================

-- 001: Events and Affiliates
...
select e.id, 'https://picsum.photos/seed/' || replace(e.slug, '-', '') || '/1920/1080', 'fallback'
from events e where e.id not in (select event_id from hero_assets);
update events e set hero_asset_id = ha.id from hero_assets ha where ha.event_id = e.id and e.hero_asset_id is null;
