    ...
    <main className="min-h-screen relative" style={{ background: 'transparent' }}>
      ...
      <section className="relative px-6 pt-32 pb-24 min-h-[70vh] flex flex-col justify-end overflow-hidden isolate">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <h1 className="mb-4" style={{ fontFamily: 'var(--font-tech)', fontSize: 'clamp(2rem, 5vw, 3.5rem)', lineHeight: 1.1, textShadow: '0 2px 20px rgba(0,0,0,0.6), 0 4px 40px rgba(0,0,0,0.3)' }}>AI Summit 2026</h1>
