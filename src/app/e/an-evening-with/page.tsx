    ...
    <main className="min-h-screen relative" style={{ background: 'var(--color-bg)' }}>
      ...
      <section className="relative px-6 pt-32 pb-24 min-h-[70vh] flex flex-col justify-end">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="mb-4" style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(2rem, 5vw, 3.5rem)', lineHeight: 1.1 }}>An Evening With James Dyson</h1>
          <p className="mb-6" style={{ color: accentColor, fontSize: '1.25rem', fontFamily: 'var(--font-mono)' }}>Intimate keynote · Innovation through failure</p>
